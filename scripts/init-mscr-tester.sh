...
#
#----------------------------------
podman exec yti-postgres psql -U postgres -d groupmanagement -c "INSERT INTO public.user VALUES ('admin@localhost','Admin','User',true,null,null,'4ce70937-6fa4-49af-a229-b5f10328adb8')"
podman exec yti-postgres psql -U postgres -d groupmanagement -c "INSERT INTO public.user VALUES ('editor@localhost','Editor','User',true,null,null,'4ce70937-6fa4-49af-a229-b5f10328adb7')"
podman exec yti-postgres psql -U postgres -d groupmanagement -c "INSERT INTO public.user VALUES ('member@localhost','Member','User',true,null,null,'4ce70937-6fa4-49af-a229-b5f10328adb6')"
podman exec yti-postgres psql -U postgres -d groupmanagement -c "INSERT INTO public.user VALUES ('outsider@localhost','Outsider','User',true,null,null,'4ce70937-6fa4-49af-a229-b5f10328adb5')"
#----------------------------------
#----------------------------------
